...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const characters = [
        ...
        { name: "ニコ", country: "例外", weapon: "法器", element: "炎", birth_month: "", birthday: "", version: "n.6", rarity: ['☆５'], body: "中身女性", role: ["オフフィールドサポーター","オフフィールドライフキーパー"], energy: "", talent_boss: "昏き魘夢の主", local_specialty: "琥珀香", ascension_stat: "", distributed: false, talent_book: "", talent_weekly: "あたらしい博士", special_dish: "", trace: false, costume: false },
        { name: "ローエン", country: "モンド", weapon: "長柄武器", element: "氷", birth_month: "", birthday: "", version: "n.6", rarity: ['☆５'], body: "中身男性", role: ["オンフィールドアタッカー"], energy: "", talent_boss: "集光の月ヤモリ", local_specialty: "フェザーモス", ascension_stat: "", distributed: false, talent_book: "", talent_weekly: "昇揚のサンプル「ナイト」", special_dish: "", trace: false, costume: false },
        { name: "プルーネ", country: "モンド", weapon: "法器", element: "風", birth_month: "", birthday: "", version: "n.6", rarity: ['☆４'], body: "ロリ", role: ["オフフィールドサポーター"], energy:"" , talent_boss: "霜夜の空を巡る霊主", local_specialty: "", ascension_stat: "", distributed: false, talent_book: "", talent_weekly: "", special_dish: "", trace: false, costume: false }
    ];
