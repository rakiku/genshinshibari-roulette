document.addEventListener('DOMContentLoaded', function() {
    ...
    const characters = [
        ...
        { name: "アルレッキーノ", country: "スネージナヤ", weapon: "長柄武器", element: "炎", birth_month: "８月", version: "n.6", rarity: ['☆５'], body_type: "長身女性", role: ["オンフィールドアタッカー"], energy: 60, ascension_stat: "会心ダメージ", boss_material: "魔像レガトゥス", local_specialty: "レインボーローズ", is_distributed: false },
        // ナドクライ
