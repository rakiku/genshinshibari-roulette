...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const characters = [
        ...
        { name: "ローエン", country: "モンド", weapon: "長柄武器", element: "氷", birth_month: "", birthday: "", version: "n.6", rarity: ['☆５'], body: "中身男性", role: ["オンフィールドアタッカー"], energy: "", talent_boss: "集光の月ヤモリ", local_specialty: "フェザーモス", ascension_stat: "", distributed: false, talent_book: "抗争", talent_weekly: "昇揚のサンプル「ナイト」", special_dish: "", trace: false, costume: false, enemy_material: [], training_road: false, release_version: "Luna VII (6.6)" },
