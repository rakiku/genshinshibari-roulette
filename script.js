document.addEventListener('DOMContentLoaded', function() {
    ...
    function showPopup(text) {
        ...
        popup.innerHTML = `<span class="popup-close">&times;</span>${text}`;
