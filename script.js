document.addEventListener('DOMContentLoaded', function() {
    ...
    const binds = ["☆４キャラ武器", "回復禁止", "恒常☆５縛り", "国縛り", "モノ元素縛り", "武器種縛り", "誕生月", "キャラルーレット", "キャラ武器ルーレット"];
    ...
    function startRoulette(type) {
        ...
        if (type === 'all' || type === 'boss') {
            ...
            items = binds.filter(b => !results.common.includes(b) && !Object.values(results.players[0]).includes(b));
        }
        drawRoulette();
    }
