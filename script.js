...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const characters = [
        ...
        { name: "ニコ", country: "例外", weapon: "法器", element: "炎", birth_month: "９月", birthday: "9月29日", version: "n.6", rarity: ['☆５'], body: "中身女性", role: ["オフフィールドサポーター","オフフィールドライフキーパー"], energy: "60", talent_boss: "昏き魘夢の主", local_specialty: "琥珀香", ascension_stat: "", distributed: false, talent_book: "楽園", talent_weekly: "あたらしい博士", special_dish: "", trace: false, costume: false },
